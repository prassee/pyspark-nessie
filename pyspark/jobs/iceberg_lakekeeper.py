...
def create_spark_session():
    """Create Spark session with Iceberg and LakeKeeper REST configuration"""
    return (
        SparkSession.builder.appName("IcebergWithLakekeeper")
        .config(
        ...
        .config("spark.sql.catalog.lakekeeper.uri", "http://nessie:19120/api/v1")
        .config("spark.sql.catalog.lakekeeper.warehouse", "s3a://warehouse/")
